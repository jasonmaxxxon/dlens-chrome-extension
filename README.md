...
- C-Backend read-model hardening remains Product mode P0: B1+B2+B3 landed; the remaining gate is golden thread fixtures across backend and extension projection.
