...
> Reference only — chosen direction is `src/ui/tokens.ts` warm editorial + macOS utility shell. See `docs/handoff/2026-06-18-visual-reset-A-plan.md`.

**File:** `docs/mockups/references/2026-06-09-design-gallery.html` (← → or left rail switches design; top pills switch mode)
**Mockup reference only** — production `src/ui/tokens.ts` is the active design contract.
...
## Next
1. User picks favourite(s) → refine that one (motion chains, type scale, per-mode fine-tuning).
